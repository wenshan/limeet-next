...
"[project]/src/components/CategoriesFooter/index.jsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const getCategoriesFetchServer = async ({ lang })=>{
    ...
    const language1 = lang || 'ja-JP';
    try {
        const result = await queryProductCategoriesServer({
            projectId,
            language: language1
        });
        if (result && result.status && result.status === 200 && result.data.rows && result.data.rows[0]) {
            const allCategories = Object.assign({}, allCategoriesInit[language1]);
...
"[project]/src/components/ClientRunTimeDom/index.jsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
'use client';
;
function ClientRunTimeDom({ lang }) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__e538afe5._.js.map