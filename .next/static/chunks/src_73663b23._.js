...
;
;
const getCategoriesFetchServer = async (param)=>{
    let { lang } = param;
...
function ClientRunTimeDom(param) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "ClientRunTimeDom.useEffect": ()=>{
            if ($) {
                $({
                    "ClientRunTimeDom.useEffect": function() {
                        // 轮播图组件
                        class Carousel {
                            init() {
                                // 创建指示器
                            ...
                            addSwipeSupport() {
                                ...
                                this.$container.on('touchstart', {
                                    "ClientRunTimeDom.useEffect": function(e) {
                            ...
                            goToSlide(index) {
                                ...
                                })["ClientRunTimeDom.useEffect"].bind(this), 500);
                            }
                            // 下一张
                            nextSlide() {
                            ...
                            startAutoPlay() {
                                ...
                                })["ClientRunTimeDom.useEffect"].bind(this), this.autoPlayDelay);
                            }
                            // 停止自动播放
                            stopAutoPlay() {
...
//# sourceMappingURL=src_73663b23._.js.map